...
p = subprocess.Popen("cp hyperoptArrayTemplate.sh logs/cache/hyperoptArrayTemplate.sh && cd logs/cache/ && sbatch hyperoptArrayTemplate.sh "+ip, stdout=log, stderr=log, shell=True)
